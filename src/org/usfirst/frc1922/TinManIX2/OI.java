...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1 = new JoystickButton(operatorJoy, 5);
        joystickButton1.whenPressed(new SolenoidToggle1());
        ...
        SmartDashboard.putData("Solenoid Toggle 1", new SolenoidToggle1());

        SmartDashboard.putData("PneumaticCG", new PneumaticCG());


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
       joystickButton2 = new JoystickButton(operatorJoy, 3);
       joystickButton2.whenPressed(new SolenoidToggle2());
    }
